...
for index in range(0, 27, 1):
    kaggle_kafka_dict_list.append(
        {"avro": config.POST_ANSWER_TOPIC_CONFIG['avro'], "topic": config.POST_ANSWER_TOPIC_CONFIG['topic'],
         "table": "posts_answers", "read_count": read_count, "start": thread_max_count * index,
